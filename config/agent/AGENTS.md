...
- Treat agent, subagent, and agent-coms seat names as ephemeral coordination metadata. Do not write transient seat names into durable or team-facing artifacts such as PR review threads, commit messages, changelogs, plans, or project docs. Use generic wording such as “independent cross-review” or identify the model/provider when attribution matters; preserve real human identities.
